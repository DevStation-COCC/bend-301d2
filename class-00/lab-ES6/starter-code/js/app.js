...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: This has to do with the scope of the variables let is more strict then var is. Var can be local/global where let is strictly local.
  console.log(viewed);
