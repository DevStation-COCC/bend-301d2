...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT - line 33 is within the while loop of the diaplayPics function whereas the console log is outside of the function such that rando is unavailable.
  console.log(viewed);
