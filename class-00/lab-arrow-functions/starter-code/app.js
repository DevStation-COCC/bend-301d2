...
//  line 206. Returns undefined.  This has not been defined within the scope function
// 2. What is "this" when joe.scopeArrow() is invoked?
// line 211. Returns undefined.  This is referring to an undefined reference to joe.  Arrows do not have prototype properties.
// 3. Explain why "this" is different when an arrow function is used.
//  line 208. The arrow is different because it lacks any binding.  The this value will use its enclosing lexical scope.  This is 
// not present in the current scope so it finds this from the enclosing scopt.
// The this is referring to higher level functions that are defined up to the root window object that is returned in this example.
//  Other higher level functions may be encountered before the window but not in this example.
