...
console.log(joe);
// Arrow functions DO NOT like the keyword THIS.
...
// Arrow functions automatically bind the context
...
// An empty window object is returned. 
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// This comes back as undefined.
//
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions can't bind THIS and they just use the value of THIS in their scope. 
// They only see THIS in the code block it is currently in and does not care what it is called,
// but greatly cares WHERE it is called. 